...
# Graph input dimension (spectral embedding dimension + 1)
parser.add_argument('--spectral-emb-dim', type=int, default=10, help="Dimensionality of spectral embeddings for graph structure representation (default: 10)")

# Hidden dimension size for the graph encoder network
parser.add_argument('--graph-hidden-dim', type=int, default=64, help="Hidden dimension size for graph encoder layers (default: 64)")

# Latent dimension for the model
parser.add_argument('--latent-dim', type=int, default=32, help="Latent dimension for the model (default: 32)")

# Number of layers in the graph encoder network
parser.add_argument('--graph-num-layers', type=int, default=2, help="Number of layers in the graph encoder network (default: 2)")

# Number of attention heads in the graph encoder
parser.add_argument('--graph-heads', type=int, default=4, help="Number of attention heads in the graph encoder (default: 4)")

# Maximum number of nodes in graphs
parser.add_argument('--n-max-nodes', type=int, default=50, help="Maximum number of nodes in the graph (default: 50)")

# Dimensionality of text latent space
parser.add_argument('--text-latent-dim', type=int, default=768, help="Dimensionality of text latent vectors (default: 768)")

# Output dimension (dimension of decoded features)
parser.add_argument('--output-dim', type=int, default=128, help="Output dimension (dimension of decoded graph features) (default: 128)")

# Flag to enable/disable training of the GAN model
parser.add_argument('--train-gan', action='store_true', default=True, help="Flag to enable GAN training (default: enabled)")
...
# Save to a CSV file
with open("output_or_L1_L2_param_4.csv", "w", newline="") as csvfile:
